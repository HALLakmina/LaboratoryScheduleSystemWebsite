...
<html lang="en">
    ...
    <body class="w-full bg-[url('../../resources/img/Wallpaper.jpg')] bg-cover bg-center bg-no-repeat backdrop-blur-xs min-h-svh overflow-auto" id="index-content">
                ...
                <div class="flex flex-col gap-6 xl:ml-[344px]">
                    ...
                    <section id="admin-timetable-settings" data-admin-section class="hidden bg-white/92 rounded-2xl p-5 shadow-lg lg:h-[calc(100svh-10rem)] lg:overflow-y-auto">
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <button id="admin-refresh-btn" type="button" class="bg-gray-950 text-white font-black px-4 py-3 rounded-xl hover:bg-sky-700">Refresh Panel</button>
                        </div>
                    ...
                    <section id="admin-manage-timetable" data-admin-section class="hidden bg-white/92 rounded-2xl p-5 shadow-lg lg:h-[calc(100svh-10rem)] lg:overflow-y-auto">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <button id="admin-timetable-create-btn" type="button" class="bg-sky-600 text-white font-black px-4 py-3 rounded-xl hover:bg-sky-700">New Timetable Record</button>
                        </div>
                    ...
                    <section id="admin-groups" data-admin-section class="hidden bg-white/92 rounded-2xl p-5 shadow-lg lg:h-[calc(100svh-10rem)] lg:overflow-y-auto">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                            ...
                            <button id="admin-group-create-btn" type="button" class="bg-sky-600 text-white font-black px-4 py-3 rounded-xl hover:bg-sky-700">New Group</button>
                        </div>
                        <div id="admin-groups-list" class="pt-5 overflow-x-auto"></div>
                    </section>

                    <section id="admin-labs" data-admin-section class="hidden bg-white/92 rounded-2xl p-5 shadow-lg lg:h-[calc(100svh-10rem)] lg:overflow-y-auto">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                            ...
                            <button id="admin-lab-create-btn" type="button" class="bg-sky-600 text-white font-black px-4 py-3 rounded-xl hover:bg-sky-700">New Lab</button>
                        </div>
                    ...
                    <section id="admin-subjects" data-admin-section class="hidden bg-white/92 rounded-2xl p-5 shadow-lg lg:h-[calc(100svh-10rem)] lg:overflow-y-auto">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <button id="admin-subject-create-btn" type="button" class="bg-sky-600 text-white font-black px-4 py-3 rounded-xl hover:bg-sky-700">New Subject</button>
                        </div>
                    ...
                    <section id="admin-users" data-admin-section class="hidden bg-white/92 rounded-2xl p-5 shadow-lg lg:h-[calc(100svh-10rem)] lg:overflow-y-auto">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <button id="admin-user-create-btn" type="button" class="bg-emerald-600 text-white font-black px-4 py-3 rounded-xl hover:bg-emerald-700">New User</button>
                        </div>
        ...
        <section id="admin-timetable-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-timetable-form" class="w-full max-w-4xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-4 my-8 mx-auto">
                ...
                <select id="admin-timetable-subject" name="subject_cord" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                    <option value="">Select subject code</option>
                </select>

                <select id="admin-timetable-group" name="lecture_group_id" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                    <option value="">Select group</option>
                </select>

                <select id="admin-timetable-lab" name="lab_id" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                    <option value="">Select lab</option>
                </select>

                <select id="admin-timetable-action" name="action" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                    <option value="free">FREE</option>
                    <option value="active">ACTIVE</option>
                    <option value="cancel">CANCEL</option>
                </select>

                <select id="admin-timetable-day" name="day" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                    <option value="">Select day</option>
                </select>

                <select id="admin-timetable-time-slot" name="time_slot" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                    <option value="">Select time slot</option>
                </select>

                <div class="md:col-span-2 flex gap-3 justify-end">
                    <button id="admin-timetable-form-cancel" type="button" class="bg-gray-200 text-gray-900 font-black px-5 py-3 rounded-xl hover:bg-gray-300">Cancel</button>
                    <button type="submit" class="bg-gray-950 text-white font-black px-5 py-3 rounded-xl hover:bg-sky-700">Save Record</button>
                </div>
            </form>
        </section>

        <section id="admin-settings-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-settings-form" class="w-full max-w-3xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 md:grid-cols-4 gap-4 my-8 mx-auto">
                ...
                <input type="number" id="admin-settings-rows" min="0" placeholder="Rows" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <input type="number" id="admin-settings-columns" min="0" placeholder="Columns" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <input type="number" id="admin-settings-break-row" min="0" placeholder="Break row number" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <div class="flex gap-3 md:justify-end md:col-span-1">
                    <button id="admin-settings-form-cancel" type="button" class="bg-gray-200 text-gray-900 font-black px-4 py-3 rounded-xl hover:bg-gray-300">Cancel</button>
        ...
        <section id="admin-time-slot-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-time-slot-form" class="w-full max-w-4xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 md:grid-cols-4 gap-4 my-8 mx-auto">
                ...
                <div class="flex gap-3 md:justify-end">
                    <button id="admin-time-slot-form-cancel" type="button" class="bg-gray-200 text-gray-900 font-black px-4 py-3 rounded-xl hover:bg-gray-300">Cancel</button>
                    <button type="submit" class="bg-gray-950 text-white font-black px-4 py-3 rounded-xl hover:bg-sky-700">Save</button>
                </div>
            </form>
        </section>
        ...
        <section id="admin-news-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-news-form" class="w-full max-w-4xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-4 my-8 mx-auto" enctype="multipart/form-data">
                <div class="md:col-span-2 flex items-start justify-between gap-4">
                    <div>
                        <p class="text-sm uppercase tracking-[0.25em] text-gray-500 font-black">News</p>
                ...
                <input type="text" id="admin-news-title" name="title" placeholder="News title" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 font-bold" required>
                <input type="file" id="admin-news-image" name="image" accept="image/*" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                <textarea id="admin-news-description" name="description" placeholder="News description" class="md:col-span-2 min-h-[120px] rounded-xl border border-gray-300 bg-white px-4 py-3"></textarea>
                <input type="date" id="admin-news-start-date" name="start_date" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                <input type="date" id="admin-news-end-date" name="end_date" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                <input type="time" id="admin-news-start-at" name="start_at" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                <input type="time" id="admin-news-end-at" name="end_at" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                <div class="md:col-span-2 flex gap-3 justify-end">
                    <button id="admin-news-form-cancel" type="button" class="bg-gray-200 text-gray-900 font-black px-5 py-3 rounded-xl hover:bg-gray-300">Cancel</button>
                    <button type="submit" class="bg-gray-950 text-white font-black px-5 py-3 rounded-xl hover:bg-sky-700">Save News</button>
                </div>
            </form>
        </section>
        ...
        <section id="admin-request-confirm-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-request-confirm-form" class="w-full max-w-4xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-4 my-8 mx-auto">
                ...
                <div class="md:col-span-2 flex items-center justify-between gap-3">
                    <button id="admin-request-check-availability" type="button" class="bg-sky-600 text-white font-black px-5 py-3 rounded-xl hover:bg-sky-700">Check Booking</button>
        ...
        <section id="admin-subject-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-subject-form" class="w-full max-w-3xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 md:grid-cols-3 gap-4 my-8 mx-auto">
                ...
                <input type="text" id="admin-subject-code" name="subject_cord" placeholder="Subject code" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <input type="text" id="admin-subject-name" name="subject" placeholder="Subject name" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <select id="admin-subject-year" name="year_id" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
        ...
        <section id="admin-group-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-group-form" class="w-full max-w-2xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 gap-4 my-8 mx-auto">
                <div class="flex items-start justify-between gap-4">
                    <div>
                ...
                <input type="text" id="admin-group-name" name="group_name" placeholder="Group name" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <div class="flex gap-3 justify-end">
                    <button id="admin-group-form-cancel" type="button" class="bg-gray-200 text-gray-900 font-black px-5 py-3 rounded-xl hover:bg-gray-300">Cancel</button>
                    <button type="submit" class="bg-gray-950 text-white font-black px-5 py-3 rounded-xl hover:bg-sky-700">Save Group</button>
                </div>
            </form>
        </section>
        <section id="admin-lab-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-lab-form" class="w-full max-w-3xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 gap-4 my-8 mx-auto">
                <div class="flex items-start justify-between gap-4">
                    <div>
                ...
                <input type="text" id="admin-lab-name" name="lab_name" placeholder="Lab name" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <input type="text" id="admin-lab-location" name="lab_location" placeholder="Lab location" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <div class="flex gap-3 justify-end">
                    <button id="admin-lab-form-cancel" type="button" class="bg-gray-200 text-gray-900 font-black px-5 py-3 rounded-xl hover:bg-gray-300">Cancel</button>
                    <button type="submit" class="bg-gray-950 text-white font-black px-5 py-3 rounded-xl hover:bg-sky-700">Save Lab</button>
                </div>
            </form>
        </section>
        <section id="admin-user-form-modal" class="hidden fixed inset-0 bg-gray-950/50 z-30 overflow-y-auto p-4">
            <form id="admin-user-form" class="w-full max-w-4xl bg-white rounded-2xl p-5 shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-4 my-8 mx-auto">
                <div class="md:col-span-2 flex items-start justify-between gap-4">
                    <div>
                ...
                <input type="text" id="admin-user-initials" name="initials" placeholder="Initials" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <input type="text" id="admin-user-initials-stand-for" name="initials_stand_for" placeholder="Initials stand for" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <input type="text" id="admin-user-first-name" name="first_name" placeholder="First name" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <input type="text" id="admin-user-last-name" name="last_name" placeholder="Last name" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
                <select id="admin-user-honorifics" name="honorifics" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3">
                ...
                <select id="admin-user-role" name="role" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3" required>
